...
import { Server, Menu, X, Shield, Cpu, Activity, LogOut, Wifi } from "lucide-react";
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-medium text-muted-foreground">
            <li className="flex items-center gap-2"><span className="text-primary font-bold">SUPPORT:</span> support@arvexhosting.com</li>
